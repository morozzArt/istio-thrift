...
class Processor(Iface, TProcessor):
  ...
  def process_get_country(self, seqid, iprot, oprot):
    ...
    oprot.writeMessageBegin("get_country", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class get_country_result:
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (Country, Country.thrift_spec), None, ), # 0
  )
